    ...
    board: {
      ...
      columns: [
        ...
        },
        {
           ...
           * "columnId-placeholder-car" (mỗi column chỉ có thể có tối đa một Placeholder Card)
           * Quan trọng khi tạo: phải đầy đủ: (_id, boardId, columnId, FE_PlaceholderCard)
           * *** Kỹ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ để ý đến phần tích hợp API Back-end
           */
